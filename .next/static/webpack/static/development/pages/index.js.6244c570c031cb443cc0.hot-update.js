...
})(["width:75vw;height:100vw;display:grid;grid-template-columns:repeat(7,1fr);grid-template-rows:repeat(7,1fr);.week{border-top:1px solid black;}.week:last-child{border-bottom:1px solid black;border-bottom-left-radius:5px;border-bottom-right-radius:5px;}border-radius:1rem;box-shadow:0 0 1rem silver;padding:1rem;"]);
...
//# sourceMappingURL=index.js.6244c570c031cb443cc0.hot-update.js.map